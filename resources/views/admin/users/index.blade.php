<x-app-layout>
    ...
    <div class="bg-gradient-to-r from-blue-600 via-cyan-600 to-teal-600 text-white">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-white">Colaboradores</h1>
                    <p class="mt-1 text-cyan-100">Gerencie todos os colaboradores do sistema</p>
                </div>
                <div class="flex items-center gap-3">
                    <div class="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                        <p class="text-xs text-cyan-200">Total de colaboradores</p>
    ...
    <section class="bg-gray-50 dark:bg-gray-900 py-8 pb-16">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            @if (session('success'))
                <div id="toast-success"
                     ...
                     style="transition: opacity 0.5s ease-in-out;" role="alert" x-data="{ show: true }" x-show="show"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-blue-100 text-sm font-medium">Total de Colaboradores</p>
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-green-100 text-sm font-medium">Colaboradores Ativos</p>
                            <p class="text-3xl font-bold mt-1">{{ $users->where('active', 1)->count() }}</p>
                        </div>
                        <div class="bg-white/20 rounded-lg p-3">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-xl shadow-lg p-6 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-cyan-100 text-sm font-medium">Este Mês</p>
                            <p class="text-2xl font-bold mt-1">{{ $users->where('created_at', '>=', now()->startOfMonth())->count() }}</p>
                            <p class="text-xs text-cyan-200 mt-1">novos cadastros</p>
                        </div>
                        <div class="bg-white/20 rounded-lg p-3">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
                <form method="GET" action="{{ route('admin.users.index') }}" id="filterForm" x-data="filterData" x-cloak>
                    <!-- Linha de Busca -->
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="search" id="simple-search" x-model="filters.search"
                                       ...
                                       placeholder="Buscar colaboradores por nome, email ou CPF..."
                    ...
                    <div x-show="hasActiveFilters()" x-transition
                        ...
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <template x-if="filters.search">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-cyan-100 text-cyan-800 dark:bg-cyan-900 dark:text-cyan-200">
                                    ...
                                    <button type="button" @click="filters.search = ''; applyFilters()" 
                                            class="ml-2 inline-flex items-center justify-center w-4 h-4 rounded-full hover:bg-cyan-200 dark:hover:bg-cyan-700 transition-colors">
                                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                                        </svg>
                                    </button>
                            ...
                            <button type="button" @click="clearFilters()"
                                    class="ml-auto text-xs text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium">
                                Limpar todos
                            </button>
                        </div>
                    </div>
