            ...
            <tr
                ...
                <td class="py-4 px-6">
                    <div class="flex items-center">
                        ...
                        <span x-text="category.active ? 'Ativo' : 'Inativo'"></span>
                    </div>
                </td>
                <td class="px-6 py-4 flex items-center">
                    <a href="#" x-on:click="viewCategory($event, category.id)" class="font-medium mr-3 text-green-600 dark:text-green-500 hover:underline">Detalhes</a>
                    <div x-data="{ selectedcategoryId: null }">
                        <script>
                    ...
                    <a href="#" x-on:click="editCategory($event, category.id)"
                        ...
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Você tem certeza que deseja excluir essa categoria?</h3>
                                    <button data-modal-hide="popup-modal"  x-on:click="deleteCategory($event, category.id)" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                        Sim, tenho certeza
                                    </button>
                    ...
                    <script>
                        function deleteCategory(event, categoryId) {
                            ...
                            fetch(`/categorias/${categoryId}/excluir`, {
                                    method: 'DELETE',
                                    headers: {
