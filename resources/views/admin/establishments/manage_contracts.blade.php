                                    ...
                                    <tr class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="py-4 px-6">
                                            <div class="flex items-center gap-2">
                                                @if ($contract->status != 'pago')
                                                    <form action="{{ route('admin.establishments.contracts.pay', [$establishment->id, $contract->id]) }}" method="POST" class="inline">
                                                        @csrf
                                                ...
                                                @else
                                                    <form action="{{ route('admin.establishments.contracts.pending', [$establishment->id, $contract->id]) }}" method="POST" class="inline">
                                                        @csrf
