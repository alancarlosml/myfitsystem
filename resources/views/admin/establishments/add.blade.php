        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white">Adicionar Estabelecimento</h1>
                        <p class="mt-1 text-amber-100">Preencha os dados para cadastrar um novo estabelecimento</p>
                    </div>
                </div>
            </div>
        </div>
