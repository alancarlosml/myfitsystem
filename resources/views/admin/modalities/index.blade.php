                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 py-4">
                    ...
                    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <a href="{{ route('admin.modalities.create') }}" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                ...
                <form method="POST" action="{{ route('admin.modalities.attach') }}">
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div class="flex items-center p-2 border border-gray-200 rounded dark:border-gray-700 mr-3 mb-2">
                            ...
                            <label for="bordered-checkbox-{{ $modality->id }}" class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $modality->name }}</label>
                        </div>
                        @endforeach
                    </div>
