    ...
    <tbody>
        @foreach($workoutLogs as $workoutLog)
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td scope="row"
                    class="py-4 px-5">
                    {{ \Carbon\Carbon::parse($workoutLog->date)->format('d/m/Y') }}
                </td>
                <td class="px-6 py-4">
                    <div class="flex items-center space-x-2">
                        <a href="{{ route('admin.workout_logs.view', $workoutLog->id) }}" title="Detalhes"
                        ...
                        <a href="{{ route('admin.workout_logs.edit', $workoutLog->id) }}" title="Editar"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Você tem
                                        certeza que deseja excluir este log de treino?</h3>
                                    <button data-modal-hide="popup-modal" onclick="deleteWorkoutLog({{ $workoutLog->id }})"
                                            type="button"
                    ...
                    <script>
                        function deleteWorkoutLog(workoutLogId) {
                            // Create a form to delete the workout log
                            const form = document.createElement('form');
                            form.method = 'POST';
                            form.action = `/gestao/logs-treinos/${workoutLogId}/excluir`;
