                ...
                <td class="p-4 w-4">
                    <div class="flex items-center">
                        <input type="checkbox"
                               ...
                               :checked="selectAll"> <label :for="`checkbox-table-search-` + user.id"
                ...
                <td class="py-4 px-6">
                    <div class="flex items-center">
                        <div class="inline-block w-4 h-4 mr-2 rounded-full"
                             x-bind:class="user.active ? 'bg-green-700' : 'bg-red-700'"></div>
                        <span x-text="user.active ? 'Ativo' : 'Inativo'"></span>
                    </div>
                </td>
                <td class="px-6 py-4">
                    <div class="flex items-center space-x-2">
                        <a href="#" x-on:click="viewUser($event, user.id)" title="Detalhes"
                        ...
                        <a href="#" x-on:click="editUser($event, user.id)" title="Editar"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 text-center">
                                    ...
                                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Você tem
                                        certeza que deseja excluir este usuário?</h3>
                    ...
                    <script>
                        function deleteUser(event, userId) {
                            ...
                            fetch(`/gestao/usuarios/${userId}/excluir`, {
                                    method: 'DELETE',
                                    headers: {
                                ...
                                .then(response => {
                                    if (response.ok) {
                                        window.location.href = '{{ route('admin.system_users.index') }}';
                                    } else {
