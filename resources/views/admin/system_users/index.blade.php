            ...
            <div class="relative overflow-hidden">
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form method="GET" action="{{ route('admin.system_users.index') }}" class="flex items-center">
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <a href="{{ route('admin.system_users.create') }}"
                ...
                <div class="overflow-x-auto" x-data="{ users: {{ @json_encode($users) }}, selectAll: false }">
                    @include('admin.system_users.partials.table', ['users' => $users])
                </div>
            </div>
        </div>
    </section>
