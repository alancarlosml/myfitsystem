        ...
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-violet-100">Gerencie todas as suas notificações</p>
                </div>
                <div class="flex items-center gap-3">
                    <div class="bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2">
                        <p class="text-xs text-violet-200">Não lidas</p>
                        <p class="text-2xl font-bold text-white"><span id="unread-count">{{ $unreadCount }}</span></p>
                    </div>
                    <form action="{{ route('admin.notifications.mark_all_read') }}" method="POST" id="mark-all-read-form">
                        @csrf
                        <button type="submit" 
